...
onMounted(async () => {
  ...
  try {
    const response = await axios.get('https://vue-example-e0cb8-default-rtdb.firebaseio.com/surveys.json')
...
const onSubmit = (e: Event) => {
  ...
  // }
  // )
  axios.post('https://vue-example-e0cb8-default-rtdb.firebaseio.com/surveys.json', {
    name: userName.value,
